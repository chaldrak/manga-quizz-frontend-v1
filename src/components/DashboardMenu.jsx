    ...
    <>
      <div className="dashboard">
        ...
        <div className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col bg-[#101529]">
            <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
              <div className="flex flex-shrink-0 items-center px-4 pt-8" />
            ...
            <div className="flex flex-shrink-0 bg-[#101529] p-4">
              <NavLink
                to="/account"
